...
plot_delbo_boxplot(
    ...
    outpath=os.path.join(_HERE, "admix_thru_b_plus_ancient_dELBO_Nfixed_hapibd.png"),
...
plot_param_comparison(
    ...
    outpath=os.path.join(_HERE, "admix_thru_b_plus_ancient_params_Nfixed_hapibd.png"),
...
plot_relative_error_boxplot(
    ...
    outpath=os.path.join(_HERE, "admix_thru_b_plus_ancient_relative_error_Nfixed_hapibd.png"),
